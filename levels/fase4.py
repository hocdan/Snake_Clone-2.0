'''
    ...
    LEVEL 4 - arquivo que carrega a primeira fase do jogo 
...
class Fase4(State):
    ...
    def onEnter(self, game):
        ...
        self.player = Snake(posX=64, posY=8, dir='s', Dx=8, vidas=self.dados[0], pontos=self.dados[1], tipo="planta")
        self.world = World_SNAKE(pyxel.tilemaps[0], largura=16, altura=16, baseX=48, baseY=0, tamanho=8, SNAKE=self.player)
    ...
    def update(self, game):
        ...
        if (not self.GAME_OVER):
            ...
            if ( len(self.player.corpo) == 10):
                self.world.change_worldItens(7, 15, WorldItem_SNAKE.PORTAL_DOWN)
                self.world.change_worldItens(8, 15, WorldItem_SNAKE.PORTAL_DOWN)
