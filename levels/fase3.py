'''
    ...
    LEVEL 3 - arquivo que carrega a terceira fase do jogo 
    ...
    def update(self, game):
        ...
        if (not self.GAME_OVER):
            ...
            if ( len(self.player.corpo) == 10):
                self.world.change_worldItens(6, 0, WorldItem_SNAKE.PORTAL_UP)
                self.world.change_worldItens(7, 0, WorldItem_SNAKE.PORTAL_UP)
