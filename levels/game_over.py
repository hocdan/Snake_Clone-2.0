...
class GameOver(State):
    ...
    def onEnter(self, game):
        ...
        self.decoration = world.World_SNAKE(pyxel.tilemaps[2], largura=16, altura=17, baseX=16, baseY=0, tamanho=8)
    ...
    def update(self, game):
        ...
        if (pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT, hold=30)):
            if (self.mouseOnJogar):
                ...
                #encerrando musica da janela GAME OVER e iniciando musica da fase1
                pyxel.stop(3)
