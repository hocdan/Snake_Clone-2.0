...
class Snake:
    ...
    def __init__(self, posX, posY, dir='s', Dx=8, vidas=3, pontos=0, tipo="planta"):
        self.posX = posX
        self.posY = posY
        self.largura = 8 #dimensoes dos segmentos da cobra para verificar colisao
        self.altura = 8 #dimensoes dos segmentos da cobra para verificar colisao
        ...
        self.tipo = tipo #atributo usado para saber qual conjunto de sprites usar (padrao = planta)
        self.dirAtual = dir #flag usada para saber em que direcao a cobra esta se movendo (padrao = para baixo)
        ...
        if (self.dirAtual == 's'):
            cauda = SnakePart(self.posX, self.posY-self.largura, "tail", self.dirAtual, 0, -1)
        elif (self.dirAtual == 'd'):
            cauda = SnakePart(self.posX-self.largura, self.posY, "tail", self.dirAtual, 0, -1)
        elif (self.dirAtual == 'a'):
            cauda = SnakePart(self.posX+self.largura, self.posY, "tail", self.dirAtual, 0, -1)
        elif (self.dirAtual == 'w'):
            cauda = SnakePart(self.posX, self.posY+self.largura, "tail", self.dirAtual, 0, -1)
